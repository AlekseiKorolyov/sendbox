...
Теперь обновите символ «о», чтобы он соответствовал «о» и «0» (цифре).
...
Вы пока не находите бесплатные деньги, потому что вам нужно найти и конец строки. Как и в случае с якорем ^, вы можете использовать якорь $ для поиска конца строки. Обновите ваше регулярное выражение, чтобы оно находило либо конец строки, либо пробел, как вы это сделали для начала строки.
...
Используя тот же синтаксис, обновите c так, чтобы он соответствовал c, {, [, и (.
...
Наконец, разрешите вашему регулярному выражению сопоставлять целые слова (как вы это делали с freeRegex).
...
Ваше итоговое регулярное выражение будет искать строки типа «дорогой друг». Объявите класс dearRegex и присвойте ему регулярное выражение, которое будет соответствовать строке «дорогой друг». Не забудьте сделать его нечувствительным к регистру и добавить его в массив denyList.
