...
95          innerText
96          .add() является противоположностью метода .remove()
...
Чтобы завершить эту функцию, необходимо восстановить класс скрытия для выходного элемента. Свойство classList имеет метод .add(), который является противоположностью метода .remove(). Он принимает строку, представляющую класс, добавляемый к элементу. Добавьте класс скрытия к выходному элементу.
