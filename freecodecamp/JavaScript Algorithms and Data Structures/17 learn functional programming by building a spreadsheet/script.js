...
Наконец, для обработки потенциальных крайних случаев добавьте пустое строковое свойство (вам потребуется использовать кавычки), которое представляет собой функцию, принимающую один аргумент и возвращающую этот аргумент. На этом ваш проект электронной таблицы завершен. Вы можете поэкспериментировать с добавлением поддержки еще большего количества функций.
